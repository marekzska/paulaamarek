      ...
      <div className="flex flex-col gap-10 lg:grid grid-cols-2 mt-10">
        <div className="flex flex-col gap-4">
          ...
          <iframe
            ...
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2662.134082796284!2d17.106853799999996!3d48.146220199999995!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x476c895c9ea45c37%3A0x5a7e2fb1c1edea60!2sDom%20Quo%20Vadis!5e0!3m2!1scs!2sch!4v1780333829276!5m2!1scs!2sch"
            width="800"
            height="450"
            style={{ border: 0 }}
        ...
        <div className="flex flex-col gap-4">
          <p
            ...
            dangerouslySetInnerHTML={{ __html: texts.whereTransportInfoText }}
          />
        </div>
      </div>
