...
export const OneWave: React.FC<WavyTextProps> = ({ text, emoji }) => {
  ...
  const wavePath =
    "M0,100 Q100,55 200,100 T400,100 T600,100 T800,100 T1000,100 T1200,100 T1400,100 T1600,100 T1800,100 T2000,100 T2200,100 T2400,100 T2600,100 T2800,100 T3000,100 T3200,100 T3400,100 T3600,100 T3800,100 T4000,100";
    ...
    <div className="w-full overflow-hidden py-8">
      ...
      >
        <defs>
          ...
          <path id="wavyPath2" d={wavePath} fill="transparent" />
        </defs>
